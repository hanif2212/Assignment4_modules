...
public class Database {
    ...
    public long insert_screenTime_used(String screen_event, String count, String date, String time)
    {
        Log.i(TAG,"here");
        ...
        long id = dbb.insert(CreateTable_screentime_used.SCREENTIME_USED_TABLE, null , contentValues);
        return id;
    }
    ...
    public String get_location_tracking()
    {
        ...
        //db.execSQL(CreateTable_screentime_used.CREATE_SCREENTIME_USED_TABLE);
        //db.execSQL(CreateTable_places_visits.CREATE_PLACE_VISITS_TABLE);
    ...
    static class CreateTable_screentime_used extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            try {
                ...
                Log.i("db","screen time table created");
            } catch (Exception e) {
                Log.e("db","error: ",e);
            }
        }
